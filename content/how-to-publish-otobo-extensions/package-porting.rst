...
Both message styles provide numerous configuration options, so make sure to consult the `component documentation <https://doc.otobo.de/doc/api/otobo/8.0/frontend/dist/designsystem/#/documentation/components/common/common-messages>`__  in the design system for complete API description.
